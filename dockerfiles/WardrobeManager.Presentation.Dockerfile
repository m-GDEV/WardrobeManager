...
#WORKDIR /src
#COPY ["WardrobeManager.Api/WardrobeManager.Api.csproj", "WardrobeManager.Api/"]
#RUN dotnet restore "./WardrobeManager.Api/WardrobeManager.Api.csproj"
#COPY . .
#WORKDIR "/src/WardrobeManager.Api"
#RUN dotnet build "./WardrobeManager.Api.csproj" -c $BUILD_CONFIGURATION -o /app/build
#
#
#FROM build AS publish
#ARG BUILD_CONFIGURATION=Release
#RUN dotnet publish "./WardrobeManager.Api.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
#
#FROM base AS final
#WORKDIR /app
